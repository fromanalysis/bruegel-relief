...
| **[painting2lamp](https://fromanalysis.github.io/bruegel-relief/painting2lamp.html)** | Not a page but a tool: drop in a painting, get the STL of the lamp shell. Cap the diameter to your printer's bed and it fits the shell to that; the stand the lamp sits on comes out at whatever height the shell ends up. One self-contained file — no install, no server, no network, and the image never leaves your browser. |
